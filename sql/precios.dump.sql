...
--
-- Name: condiciones; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE condiciones (
    tipocondicion character(4),
    prioridad integer
);
...
--
-- Name: condicionesmateriales; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE condicionesmateriales (
    tipocondicion character(4),
    material bigint,
    materialpadre bigint,
    validodesde date,
    validohasta date,
    unidadmedida character(4),
    tienda character(4),
...
ALTER TABLE condicionesmateriales OWNER TO postgres;
...
--
-- Name: precio_dia; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE precio_dia (
    tienda character(4),
    material bigint,
    unidadmedida character(4),
    fecha date,
...
ALTER TABLE precio_dia OWNER TO postgres;
...
--
-- Name: condiciones_tipocondicion_idx; Type: INDEX; Schema: public; Owner: postgres; Tablespace: 
--

CREATE UNIQUE INDEX condiciones_tipocondicion_idx ON condiciones USING btree (tipocondicion);


--
-- Name: condicionesmateriales_tienda_tipocondicion_material_unidadm_idx; Type: INDEX; Schema: public; Owner: postgres; Tablespace: 
--

CREATE UNIQUE INDEX condicionesmateriales_tienda_tipocondicion_material_unidadm_idx ON condicionesmateriales USING btree (tienda, tipocondicion, material, unidadmedida, validodesde);
...
--
-- Name: materiales_material_idx; Type: INDEX; Schema: public; Owner: postgres; Tablespace: 
--

CREATE UNIQUE INDEX materiales_material_idx ON materiales USING btree (material);


--
-- Name: precio_dia_tienda_material_fecha_unidadmedida_idx; Type: INDEX; Schema: public; Owner: postgres; Tablespace: 
--

CREATE UNIQUE INDEX precio_dia_tienda_material_fecha_unidadmedida_idx ON precio_dia USING btree (tienda, material, fecha, unidadmedida);
